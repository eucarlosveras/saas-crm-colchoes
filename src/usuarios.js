...
import { escapeHtml } from './utils.js';
        ...
        function renderAdminInicio(main) {
            ...
            <div class="action-grid" style="margin-bottom: 24px; display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                ...
                <div class="action-btn-card" onclick="navigateTo('admin_lojas')" style="background: var(--card-bg); border: 1px solid var(--border-light); padding: 24px; border-radius: var(--radius-md); cursor: pointer; transition: all 0.2s;"><span class="page-icon green" aria-hidden="true" style="margin-bottom: 12px;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></span><h4 style="font-weight: 700; margin-bottom: 4px;">Assinantes</h4><p style="font-size: var(--font-sm); color: var(--text-muted);">Gerenciar plano e status de pagamento de cada loja</p></div>
            </div>
            <div class="kpi-row">
